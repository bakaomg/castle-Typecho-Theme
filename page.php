...
?>
   <div class="mdui-card moe-post-card"<?php if(Helper::options()->TocSwitch == '1') { ?> data-toc="<?php echo ($this->fields->showToc) ? 'true' : 'false'; ?>"<?php
    $pageSeting = Castle_Contents::getSetting($this, 'tocPopup');
    $pageSeting = (isset($pageSeting)) ? $pageSeting : [];
    echo ($pageSeting === false || $pageSeting == 'false') ? ' data-popup="false"' : '';
   } ?>>
    <div class="mdui-card-media">
     ...
     <div class="mdui-card-media-covered">
      <div class="mdui-card-primary">
       ...
       <div class="mdui-card-primary-subtitle"><?php echo sprintf($GLOBALS['CastleLang']['page']['view'], Castle_Contents::PostView($this)); ?> | <?php echo sprintf($GLOBALS['CastleLang']['page']['comment'], $this->commentsNum); ?><?php if (Helper::options()->WordsCounterSwitch && in_array('page', Helper::options()->WordsCounterSwitch)) { ?> | <?php echo sprintf($GLOBALS['CastleLang']['page']['wordNum'], Castle_WordCounter::charactersNum($this)); } ?></div>
      </div>
     </div>
    </div>
    ...
    <div class="mdui-card-header">
     ...
     <div class="mdui-card-menu">
      ...
      <?php if (Helper::options()->deviceQRSwitch && in_array('page', Helper::options()->deviceQRSwitch)) {
