   ...
   <div class="mdui-card-media">
      ...
      <div class="mdui-card-media-covered">
         <div class="mdui-card-primary">
            ...
            <div class="mdui-card-primary-subtitle"><?php echo sprintf($GLOBALS['CastleLang']['page']['view'], Castle_Contents::PostView($this)); ?> | <?php echo sprintf($GLOBALS['CastleLang']['page']['comment'], $this->commentsNum); ?><?php if (Helper::options()->WordsCounterSwitch && in_array('page', Helper::options()->WordsCounterSwitch)) { ?> | <?php echo sprintf($GLOBALS['CastleLang']['page']['wordNum'], Castle_WordCounter::charactersNum($this));
                                                                                                                                                                                                                                                                                                                                                            } ?></div>
         </div>
      </div>
   </div>
