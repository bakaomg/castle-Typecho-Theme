...
var CastleOwO = {
 ...
 addOwOBtn: function() {
  ...
  editorBar[0].innerHTML += '<li class="wmd-spacer wmd-spacer1" id="wmd-spacer5"></li>';
  editorBar[0].innerHTML += '<li class="wmd-button" id="wmd-owo-button" style="margin-top: -3px;" title="插入表情" onclick="CastleOwO.toggle();"><i class="mdui-icon material-icons" style="width: 20px;height: 20px;font-size: 20px;font-weight: bolder;color: rgba(66,66,66,0.8)">sentiment_very_satisfied</i></li>';
 }
};