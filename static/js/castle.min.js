...
var CastleCreate = {
 ...
 Header: function() {
  ...
  id.innerHTML = '<div class="mdui-toolbar">\
   ...
   <a class="mdui-btn mdui-btn-icon moe-device-btn-hidden" id="toolbar-device-btn" mdui-menu="{target: \'#decice-toolbar-list\'}" no-go><i class="mdui-icon material-icons">&#xe1b1;</i></a>\
