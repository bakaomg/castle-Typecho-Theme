/**
 ...
 ----------------------------------------
 * Castle's JavaScript
 * Last Update: 2020/04/15 [0.9.4.1]
...
document.onscroll = function() {
 ...
 if (!$$('.moe-post-card #QRcode')[0] && !$$('#toolbar-device-btn').hasClass('moe-device-btn-hidden')) { $$('#toolbar-device-btn').addClass('moe-device-btn-hidden'); };
};
