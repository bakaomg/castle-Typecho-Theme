...
<?php $this->comments()->to($comments); ?>
  ...
  <div class="mdui-card moe-links-comments-box">
  ...
  <div class="moe-links-comments-list-box mdui-card" id="comments">
...
<?php if ($comments->have()){ $comments->listComments(); }?>
  ...
  <?php $comments->pageNav('<<', '>>', 1, '···', array('wrapTag' => 'div', 'wrapClass' => 'moe-links-comments-nav moe-comments-nav mdui-card mdui-card-content', 'itemTag' => 'li', 'currentClass' => 'mdui-shadow-3 current',)); ?>
