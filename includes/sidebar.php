<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
  <div class="mdui-drawer mdui-drawer-full-height mdui-drawer-close moe-sidebar" id="sidebar">
   <div class="moe-sidebar-bg" style="background: url(<?php if($this->options->sidebarBG){ echo $this->options->sidebarBG; }else{ echo themeResource('others/img/sidebar.jpg'); } ?>);"><?php if($this->options->cardt == '0'): ?>
