...
class Castle_Libs
{
  ...
  public static function resources($path, bool $version = false, bool $outType = false)
  {
    ...
    switch ($resourcesSetting) {
      ...
      case 'jsdelivr':
        $output = 'https://cdn.jsdelivr.net/gh/bakaomg/castle-Typecho-Theme@' . CASTLE_VERSION . '/' . $path;
        break;
  ...
  {
    $owoCss = (self::isDev() === true) ? 'static/css/owo.css' : 'static/css/owo.min.css';
    $owoJS = (self::isDev() === true) ? 'static/js/owo.js' : 'static/js/owo.min.js';
